...
public class PoiSearchServiceImpl implements PoiSearchService {
	...
	@Override
	public JsonObject keywordSearch(PoiSearchRequest request) throws AMapErrorException {
	...
	@Override
	public JsonObject aroundSearch(PoiSearchRequest request) throws AMapErrorException {
