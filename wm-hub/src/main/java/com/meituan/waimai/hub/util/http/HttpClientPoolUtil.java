package com.meituan.waimai.hub.util.http;
...
public class HttpClientPoolUtil {
    ...
    public static HttpClientResult getHttpClientResult(CloseableHttpResponse httpResponse, CloseableHttpClient httpClient, HttpRequestBase httpMethod)
        ...
        try {
            ...
            log.error("[HttpClientPoolUtil getHttpClientResult]耗时: {}, error: {}", System.currentTimeMillis() - start, e.getLocalizedMessage());
            e.printStackTrace();
        }
        log.info("[HttpClientPoolUtil getHttpClientResult]耗时: {}", System.currentTimeMillis() - start);
        // 获取返回结果
